...
## Do the same for distance to woodland edge
...
dist_grassland_2017 <- rast(paste0(proj_path,"GIS/Derived rasters/Distance/Extra/dist_grassland_2017_30m_temp.tif"))
dist_grassland_1995 <- rast(paste0(proj_path,"GIS/Derived rasters/Distance/Extra/dist_grassland_1995_30m_temp.tif"))
